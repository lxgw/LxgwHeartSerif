...
> [!NOTE]
> 本字体项目现已单独设立 repo，不再随附于《霞鹜新致宋》，并且不再与新致宋同步新增或调整字符。
## 概览
...
> ㊟ 不保证与（新）致宋项目同步更新。
## 授权信息
- 本字体在 IPA 所开发并发布的[「IPAex明朝」](https://moji.or.jp/ipafont)、[「こころ明朝体」](https://typingart.net/?p=46) 基础上衍生，依照 [IPA 开放字体授权条款 1.0 版（IPA Font License 1.0）](https://opensource.org/licenses/IPA/) 授权。
